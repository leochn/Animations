...
public class PullDoorView extends RelativeLayout {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			System.out.println("PullDoorView...ACTION_DOWN..." + mLastDownY);
			return true;
			
		case MotionEvent.ACTION_MOVE:
			mCurryY = (int) event.getY();
			System.out.println("PullDoorView...ACTION_DOWN..." + mCurryY);
			mDelY = mCurryY - mLastDownY;
			// 只准上滑有效
			if (mDelY < 0) {
				scrollTo(0, -mDelY);
			}
			System.out.println("PullDoorView...ACTION_DOWN..." + mDelY);
			break;
